...
public:
    ...
    static void buildTranslationScaleMatrix(float *out16, float x, float y, float scaleX, float scaleY);

    static void buildTRSMatrix(float *out16, float x, float y, float angle, float scaleX, float scaleY);
